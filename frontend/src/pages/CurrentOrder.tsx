...
import { Edit3, History, Play, RefreshCw, Search, X, XCircle } from "lucide-react";
...
export function CurrentOrder() {
  ...
  const canEdit = hasTabEdit("current_order");
  ...
  const [editDraft, setEditDraft] = useState({ quantity: 1, due_time: "00:00" });
  ...
  function openEdit(line: OrderLineOut) {
    setEditLine(line);
    setEditDraft({ quantity: line.quantity, due_time: line.due_time.slice(0, 5) });
  }
